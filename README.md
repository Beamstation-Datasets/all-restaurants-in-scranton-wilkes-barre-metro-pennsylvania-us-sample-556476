# All Restaurants in Scranton--Wilkes-Barre (Metro), Pennsylvania, US
...
| Full dataset size | 1,658 records |
| Free sample size | 165 records (9.95%) |
| Last export | 2026-05-07T11:15:26.014996+00:00 |
| Download | [Latest release asset](https://github.com/Beamstation-Datasets/all-restaurants-in-scranton-wilkes-barre-metro-pennsylvania-us-sample-556476/releases/download/sample-latest/beamstation_556476_restaurants-us-scrantonwilkesbarrepa_SAMPLE_DIST.csv) |
...
Search for dataset ID `556476` on BeamStation if you want the exact commercial listing.
